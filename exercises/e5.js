...
/** =========================
 * Create a getDiffTwentySeven(num) function to return the 
 * difference between a given number and 27
 * If the number is greater than 27 return 
...
/** =========================
 * Create a sumOfTwoIntegers(num1, num2) function 
 * to compute and return the sum of the two given integers
 * If the two argumants are same, then returns 
 * triple their sum.
...
/** =========================
 * Create a isOneOfThemOrTheirSumIsFourty(num1, num2) 
 * function to check two given numbers and return a boolean.
 * IF one of the number is 40 OR if their sum is 
 * 40 return true
